...
<body class="margin_out">
    ...
    <div class="container">
        ...
        <div class="container_form">
            ...
            <button type="button" id="button" onclick="modal('.bg-modal')" class="container_button" form="formulario1">
            ...
            <button type="button" id="button2" onclick="modal('.bg-modal-2')" class="container_button" form="formulario2">
        ...
        <div class="container_form">
            ...
            <button type="button" id="button3" onclick="modal('.bg-modal-3')" class="container_button" form="formulario3">
            ...
            <div class="espacio"></div>
            <button type="button" id="button4" onclick="modal('.bg-modal-4')" class="container_button" form="formulario4">
        ...
        <div class="container_form">
            ...
            <button type="button" id="button5" onclick="modal('.bg-modal-5')" class="container_button" form="formulario5">
        ...
        <div class="container_form">
            ...
            <button type="button" id="button6" onclick="modal('.bg-modal-6')" class="container_button" form="formulario6">
            ...
            <div class="espacio"></div>
            <button type="button" id="button7" onclick="modal('.bg-modal-7')" class="container_button" form="formulario7">
            ...
            <div>
                <button type="button" id="button8">ACTUALIZAR</button>
            </div>
        </div>
    </div>
